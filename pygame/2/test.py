...
player_1_y_prev = player_1.y
player_2_y_prev = player_2.y
...
while True:
    ...
    if ball.colliderect(player_1):
        if player_1_y_prev > player_1.y:
            velocity = degrees_to_velocity(ball_direction + 10, 10)
            ball_speed_x = velocity[0]
        if player_1_y_prev < player_1.y:
            velocity = degrees_to_velocity(ball_direction - 10, 10)
            ball_speed_x = velocity[0]
